  ...
  public void contextInitialized(ServletContextEvent sce) {
    ...
    ServletContext context = sce.getServletContext();
        ...
        try {
            ...
            Home place = new Home(address, "A stroll down memory lane", rating, image,user1);
            ...
            Home place2 = new Home(address2, "A breath of fresh air", rating2, image,user2);
            ...
            Home place3 = new Home(address3, "Once in a lifetime experience", rating3,image, user3);
            em.persist(address);
            em.persist(address2);
            em.persist(address3);
            em.persist(place);
